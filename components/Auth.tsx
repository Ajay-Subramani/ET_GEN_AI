    ...
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-header">
          <div className="auth-brand-mono">v2.5 Institutional</div>
          <h1 className="auth-title">ET GENAI</h1>
          <p className="auth-subtitle text-balance">
            Next-generation financial intelligence <br /> for high-precision capital deployment.
          </p>
        </div>
        ...
        <form onSubmit={handleAuth}>
          ...
          <button type="submit" className="auth-submit-btn" disabled={loading}>
            {loading ? "Verifying..." : mode === "signin" ? "Access Dashboard" : "Request Access"}
          </button>
        </form>
